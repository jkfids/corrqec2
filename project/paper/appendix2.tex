...
\section{Theorem proof}\label{app:proof-pt-to-spp}
...
\begin{proof}
    ...
    Finally, the coefficients \(\lambda_{\vec{\alpha}}\) can be related to the Pauli coefficients \(\tilde{\chi}_{\vec{\xi}}\) via a Walsh-Hadamard transform,
    \begin{equation}
