...
\begin{itemize}
    ...
    \item Give examples of what an environment is for a QEC setting (e.g, two-level system, or even the higher energy levels of a transmon)? If not here then maybe at the start of section 6.
\end{itemize}
}
