...
\subsection{Correlation functions and transfer operators}\label{sec:correlation-functions}
...
\subsection{Transfer spectrum analysis}\label{sec:spectral-analysis}
...
\subsection{Transfer operators beyond 1D}
...
\subsection{Hidden Markov model realisations}
