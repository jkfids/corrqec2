...
\end{equation}
where \(\Delta t_j = t_{j+1} - t_j - 1\) is the number of intermediate timesteps between \(t_j\) and \(t_{j+1}\). We now turn to the spectral properties of the transfer operator to characterise the decay of these correlations over time.
