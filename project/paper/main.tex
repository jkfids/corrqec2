...
\begin{enumerate}
  \item Section 7
  \item QCA appendix
  \item Refine appendix B
  \item Section 4 rework + possible appendix
  \item Paper overview figure for introduction
  \item Refine section headers
  \item Section 1: Introduction
  \item Section 8: Discussion
  \item Citations
  \item Title
  \item Abstract
  \item QCA model figure
  \item Surface code memory vs stability diagram
\end{enumerate}
}
