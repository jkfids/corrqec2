\Fidel{\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item \textbf{Operational Markovianization in randomized benchmarking} \cite{figueroa-romerooperational2024}: They apply multi-time randomised compiling (Pauli twirling) in the context of non-Markovian randomised
    \end{enumerate}
\end{itemize}}