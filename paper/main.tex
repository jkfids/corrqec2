...
% Commands for notation consistency
...
% Specialized bracket notation
% \newcommand{\bbra}[1]{\langle \! \langle #1 |}  % Double bra (same as \doublebra)
% \newcommand{\kket}[1]{| #1 \rangle \! \rangle}  % Double ket (same as \doubleket)
% \newcommand{\kketbbra}[2]{\kket{#1}\!\bbra{#2}}  % Double ket-bra
\newcommand{\doubleket}[1]{| #1 \rangle \! \rangle}  % Alias for \kket
\newcommand{\doublebra}[1]{\langle \! \langle #1 |}  % Alias for \bbra
\newcommand{\doublebraket}[2]{\langle \! \langle #1 | #2 \rangle \! \rangle}
\newcommand{\doubleketbra}[2]{| #1 \rangle \! \rangle \langle \! \langle #2 |}
