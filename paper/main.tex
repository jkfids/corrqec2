...
% \newcommand{\MultiTwirl}{\mathscr{T}}       % Multi-time Pauli twirling (same as process tensor)
...
% \title{Multi-time Pauli Channels from Twirled Process Tensors: Modeling Spatio-Temporally Correlated Errors for Quantum Error Correction}
